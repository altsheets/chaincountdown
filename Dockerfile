...
LABEL Password="tutum/debian:jessie says ... First time you run your container, a random password is generated for user root. To get the password: docker logs CONTAINER_ID"
